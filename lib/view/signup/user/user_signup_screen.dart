...
import 'package:tech_media/view/signup/user/user_signup_controller.dart';
      ...
      body: SafeArea(
        child: Padding(
            ...
            child: ChangeNotifierProvider(
              create: (_) => UserSignupController(),
              child: Consumer<UserSignupController>(
                    ...
                    return SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Student SignUp', style: Theme.of(context).textTheme.headline3,),
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    InputTextField(
                                      ...
                                      myController: studentIdController,
